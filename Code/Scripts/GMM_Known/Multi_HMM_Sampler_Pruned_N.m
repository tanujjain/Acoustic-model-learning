...
function [Aest,mu,cov,SeqHMMLabel,HMMRemoved] = Multi_HMM_Sampler_Pruned_N(X,Aest,mu,cov,NHmm,Pi,SeqOrigLabel,Pi_Gmm,globmu,globcov)
...
for it = 1:NumItr
   ...
   M = Cluster_Purity(SeqHMMLabel,SeqOrigLabel_pruned,NHmm,it); % Evaluate cluster purity

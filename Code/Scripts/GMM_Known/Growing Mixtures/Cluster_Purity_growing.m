...
function [ind] = Cluster_Purity_growing(SeqHMMLabel,SeqOrigLabel,NHmm,iternum)
...
% iternum: iteration number
    ...
    folder = '/home/jain/Thesis/Acoustic_Model_Learning/Code/Scripts/GMM_Known/Growing Mixtures/Cluster_Purity';
    cd(folder);

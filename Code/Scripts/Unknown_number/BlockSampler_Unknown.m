...
function [Aest,mu,cov,Pi_Gmm] = BlockSampler_Unknown(X,seqlen,Aest,mu,cov,beta_Aest,Pi,Pi_Gmm,globmu,globcov)
% Function to implement Block Gibbs sampling to update parameters of an HMM for unknown number of HMM case
% where:

...
function [Aest,mu,cov,Pi_Gmm,SeqPerHMM] = HMM_Sample_Unknown_growmix(X,Nmix,globmu,globcov,Nstates,SeqOrigLabel)
% Function to implement sampling of attributes for unknown number of HMM case with growing number of GMM mixtures
% where:
...
%% Update parameters for next iteration
   ...
   %% Split gaussians to increase number of mixtures
...
% delete parallel pool cluster and clear unneeded variables
    ...
    %% Save mat files for last two iterations 
